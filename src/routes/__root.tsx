...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Distribuidor oficial de drones DJI, XAG e Hylio en Argentina. Soluciones para agricultura, oil & gas, minería, seguridad y topografía." },
      ...
      { property: "og:description", content: "Distribuidor oficial de drones DJI, XAG e Hylio en Argentina. Soluciones para agricultura, oil & gas, minería, seguridad y topografía." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lumadron | Drones DJI, XAG e Hylio para Agro e Industria" },
      { name: "twitter:description", content: "Distribuidor oficial de drones DJI, XAG e Hylio en Argentina. Soluciones para agricultura, oil & gas, minería, seguridad y topografía." },
