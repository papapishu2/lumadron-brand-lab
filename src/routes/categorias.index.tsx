...
export const Route = createFileRoute("/categorias/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Drones para agricultura, logística, oil & gas, minería, seguridad y topografía. Elegí la solución según tu industria." },
      { property: "og:title", content: "Soluciones con Drones por Industria | Lumadron Argentina" },
      { property: "og:description", content: "Drones para agricultura, logística, oil & gas, minería, seguridad y topografía. Elegí la solución según tu industria." },
