    ...
    <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          Encontrarás un catálogo de modelos de <Link to="/marcas/$brand" params={{ brand: "dji" }} className="text-accent hover:underline">DJI</Link>, <Link to="/marcas/$brand" params={{ brand: "xag" }} className="text-accent hover:underline">XAG</Link>, <Link to="/marcas/$brand" params={{ brand: "hylio" }} className="text-accent hover:underline">Hylio</Link> y <Link to="/marcas/$brand" params={{ brand: "topxgun" }} className="text-accent hover:underline">TopXGun</Link>, categorías de uso como agricultura, oil & gas, minería, seguridad, topografía y logística, notas técnicas y del blog, y un directorio de distribuidores, importadores y representantes del país. No comercializamos directamente: facilitamos el contacto con quienes venden y brindan soporte técnico.
          </p>
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
